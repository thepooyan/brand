...
callModal.fail = (msg: string = "متاسفانه خطایی پیش آمده. لطفا مجددا تلاش کنید") => callModal(() => msg, "fail")
callModal.wait = (msg: string = "لطفا کمی صبر کنید") => callModal(() => <div class="space-y-4"><p>{msg}</p><Spinner reverse/></div>, "wait")
