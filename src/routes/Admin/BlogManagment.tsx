...
export default async function WeblogPanel() {
      ...
      <div class="grid gap-4 md:grid-cols-3">
        ...
        <Card class="bg-card">
          <CardHeader class="pb-3">
            ...
            <CardTitle class="text-3xl font-bold text-muted-foreground">4</CardTitle>
          </CardHeader>
        </Card>
      </div>
      ...
      <Card class="bg-card">
        ...
        <CardContent class="space-y-4">
          <div class="space-y-2">
            ...
            <Input id="title" placeholder="Enter post title..." class="bg-background" />
          </div>
          <div class="space-y-2">
            <Label for="excerpt">Excerpt</Label>
            <Textarea id="excerpt" placeholder="Write a brief excerpt..." rows={3} class="bg-background" />
          </div>
          <div class="flex gap-2">
            <Button variant="outline" class="flex-1 bg-transparent">
              Save as Draft
            </Button>
            <Button class="flex-1 bg-primary text-primary-foreground hover:bg-primary/90">Publish Now</Button>
          </div>
        </CardContent>
      </Card>
                ...
                <div class="flex items-start justify-between gap-4">
                  <div class="flex-1 space-y-1">
                    <div class="flex items-center gap-2">
                      <h4 class="font-semibold text-card-foreground">{post.title}</h4>
                    </div>
                  ...
                  <div class="flex gap-2">
                    ...
                    <Button size="sm" variant="ghost" class="h-8 w-8 p-0 text-destructive hover:text-destructive">
